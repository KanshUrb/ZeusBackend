...
import com.kansh.zeus.repository.trainings.TrainingItemRepository;
import com.kansh.zeus.repository.trainings.TrainingItemSeriesRepository;
...
import com.kansh.zeus.service.TrainingService;
...
public class TrainingServiceImpl implements TrainingService {
    ...
    public TrainingsDto createTraining(UsersEntity user, String name, String note, List<TrainingItemDto> trainingItems, List<String> sharedWith) {
        ...
        log.debug("user: {}, name: {}, note: {}, trainingItems: {}, sharedWith: {}", user, name, note, trainingItems, sharedWith);
        TrainingsDto trainingDto = new TrainingsDto();
        ...
        log.debug("userTrainingsEntities: {}", userTrainingsEntities);
        ...
        log.debug("trainingDto: {}", trainingDto);
